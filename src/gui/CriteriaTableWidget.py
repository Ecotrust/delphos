...
class CriteriaTableWidget(QTableWidget):
    ...
    def retranslate(self):
        #Example self. = QApplication.translate("CriteriaTableWidget", "english_text", "description", QApplication.UnicodeUTF8)                    
        self.desc_header = QApplication.translate("CriteriaTableWidget", "Description - this column provides a detailed explanation of the criterion", "Explanation of how to interpret the 'description' criteria table column", QApplication.UnicodeUTF8)                            
        self.crit_type_header = QApplication.translate("CriteriaTableWidget", "Criteria Type - this column gives you the overall type of the criterion.  Possible types include: Binary, Ordinal or Ratio\nClick help icon for more information", "Explanation of how to interpret 'criteria type' table column", QApplication.UnicodeUTF8)                            
        self.options_header = QApplication.translate("CriteriaTableWidget", "Options/Units - for Binary or Ordinal criterion this column will give you the list of available options to answer with.\n  For Ratio criteria this column will give you the unit of measure that answers must be in.  For example 'tons per year' or 'pounds',", "Explanation of how to interpret 'options/units' crit table column", QApplication.UnicodeUTF8)                           
        self.b_or_c_header = QApplication.translate("CriteriaTableWidget", "Benefit/Cost - Tells you whether the criterion is a Benefit (positive) or a Cost (negative).  Click the help icon for more information", "Explanation of the 'cost/benefit' crit table column", QApplication.UnicodeUTF8)                    
        self.no_crit_error = QApplication.translate("CriteriaTableWidget", "You must first select a criterion", "Error when a crit was not selected", QApplication.UnicodeUTF8)                    