...
class HelpTextBrowser(QTextBrowser):
    ...
    def get_doc_name(self, project_type, language):
        if project_type == 'fisheries':
            ...
            if language == 'english':
                return 'qrc:/documentation/sites/english/documentation.html'
            else:
                return 'qrc:/documentation/sites/spanish/documentation.html'
        elif project_type == "communities":
            if language == 'english':
                return 'qrc:/documentation/communities/english/documentation.html'
            else:
                return 'qrc:/documentation/communities/spanish/documentation.html'            
